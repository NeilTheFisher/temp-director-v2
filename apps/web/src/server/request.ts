// https://github.com/angular/angular-cli/blob/212ebdebdd4d5af4920131ec3dea9762cff390ea/packages/angular/ssr/node/src/request.ts
/**
 * @license
...
export function createWebRequestFromNodeRequest(
  ...
  const referrer =
    headers.referer && URL.canParse(headers.referer)
      ? headers.referer
      : undefined;
