...
export const UsersListByStatus = z
  .object({
    ...
    total: z.number().int().describe("total users").optional(),
  })
  .describe("Event sent to share the list of all users by status");
export type UsersListByStatus = z.infer<typeof UsersListByStatus>;
