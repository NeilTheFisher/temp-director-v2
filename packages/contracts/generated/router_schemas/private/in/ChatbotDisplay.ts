...
export const ChatbotDisplay = z
  .object({
    ...
    expanded: z.boolean().describe("if the chatbot results are expanded or not").optional(),
    bot_id: z
      .number()
  ...
  .describe("Event when presenter wants to display or hide chatbot results on video wall");
