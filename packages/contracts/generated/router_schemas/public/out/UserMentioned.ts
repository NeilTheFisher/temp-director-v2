...
export const UserMentioned = z
  .object({
    message: z.record(z.string(), z.any()).and(
      z
        .object({
  ...
  .describe("User was mentioned by another User");
export type UserMentioned = z.infer<typeof UserMentioned>;
