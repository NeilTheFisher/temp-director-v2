...
export const EventsList = z
          ...
          z
            .object({
              ...
              promo_video_aspect_ratio: z
                ...
                .optional(),
              downloads: z
                .array(z.string().describe("Event stream file urls"))
                .optional(),
              sponsors: z
                .object({
                  custom: z.record(
                ...
                .describe(
                  "Event sponsors with ads grouped by location under 'custom'",
                )
                .optional(),
              brand: z
                .union([
                  z
                    .object({
                      ...
                      brand_background_color: z
                        .string()
                        .describe("Brand background color"),
                      ...
                      brand_ad_image_url: z
                        .string()
                        .describe("Brand ad image url"),
                      brand_background_opacity: z
                        .number()
                        .describe("Brand background opacity"),
                      brand_logo_padding: z
                        .number()
                        .describe("Brand logo padding"),
                    })
                      ...
                      results_displayed: z
                        .object({
                          value: z
                            .boolean()
                            .describe(
                              "If chatbot results are displayed or not",
                            ),
                          expanded: z
                            .boolean()
                            .describe(
                              "If the chatbot results are expanded or not",
                            )
                            .optional(),
                        })
                        .describe(
                          "If this chatbot's results have been displayed",
                        )
                        .optional(),
              ...
              onLocation: z
                .boolean()
                .describe("If on location is enabled")
                .optional(),
              onLocationLock: z
                .boolean()
              ...
              ai_detection: z
                .boolean()
                .describe("If event's stream scans for objects")
                .optional(),
              profanity: z
                .boolean()
                .describe("Event's profanity feature")
                .optional(),
              poll_started: z
                .boolean()
                .describe(
                  "If event's poll started (deprecated, use chatbot.started instead)",
                )
                .optional(),
              event_started: z
                .boolean()
                .describe("If presenter started the event")
                .optional(),
              ...
              ask_question: z
                .boolean()
                .describe("If event's ask question is on")
                .optional(),
              is_public: z
                .boolean()
                .describe("If event is public or private")
                .optional(),
              invitations_only: z
                .boolean()
              ...
              organization: z
                .string()
                .describe("Group name of the event")
                .optional(),
              organization_image_url: z
                .string()
                .describe("Group image url")
                .optional(),
              organization_id: z.string().describe("Group id").optional(),
              ticket_url: z.string().describe("Purchase ticket url").optional(),
              ticket_platform: z
                .string()
                .describe("Purchase ticket platform")
                .optional(),
              settings: z
                .union([
                  z
                    .object({
                      ...
                      emote_settings: z
                        .union([
                          z
                            .object({
                              emote_level_zero_start: z
                                .string()
                                .describe("Emote level 0 start")
                                .optional(),
                              emote_level_one_start: z
                                .string()
                                .describe("Emote level 1 start")
                                .optional(),
                              emote_level_two_start: z
                                .string()
                                .describe("Emote level 2 start")
                                .optional(),
                              emote_level_three_start: z
                                .string()
                                .describe("Emote level 3 start")
                                .optional(),
                              emote_level_four_start: z
                                .string()
                                .describe("Emote level 4 start")
                                .optional(),
                              emote_level_five_start: z
                                .string()
                                .describe("Emote level 5 start")
                                .optional(),
                            })
              ...
              silent_mode: z
                .boolean()
                .describe("If event's silent mode is on")
                .optional(),
              ...
              payed: z
                .boolean()
                .describe("If event requires payment")
                .default(false),
              featured: z
                .boolean()
              ...
              streams: z
                .array(
                  z
                    .object({
                      ...
                      selected: z
                        .boolean()
                        .describe("If the stream was selected")
                        .optional(),
                      position: z
                        .string()
                      ...
                      users: z
                        .array(z.string())
                        .describe("Stream Assigned Users")
                        .optional(),
                      updated_at: z
                        .number()
                        .describe("Last updated at timestamp")
                        .optional(),
                    })
                ...
                .optional(),
              invites: z
                .array(z.string().describe("Guests Invited to the event"))
                .optional(),
              requests: z
                .array(
                  z.string().describe("Guests Requested to join the event"),
                )
                .optional(),
              registrations: z
                .array(z.string().describe("Guests registered to the event"))
                .optional(),
              ...
              usersConnected: z
                ...
                .optional(),
              usersInterestedCount: z
                .number()
                .int()
                .gte(0)
                .describe("Number of interested users")
                .optional(),
              mini_carousel_open: z
                .boolean()
                .describe("If event's mini_carousel is on")
                .optional(),
              mini_carousel_orientation: z
                .string()
                .describe("mini carousel orientation")
                .optional(),
              welcome_message: z
                .string()
                .describe("Message sent when presenter starts the event")
                .optional(),
              opened_list: z
                .array(z.string().describe("Guests viewed the event"))
                .optional(),
              banned: z
                .boolean()
                .describe("If user is banned from event")
                .optional(),
              blocked: z
                .boolean()
                .describe("If user is blocked from event")
                .optional(),
              opened: z
                .boolean()
                .describe("If user has opened the event")
                .optional(),
              interested: z
                .boolean()
              ...
              interested_list: z
                .array(z.string().describe("Guests interested in the event"))
                .optional(),
              event_ended: z
                .boolean()
                .describe("If event ended was triggered")
                .optional(),
              recording_started_timestamp: z
                .number()
                .describe("Timestamp when recording started")
                .optional(),
              ...
              registered: z
                .boolean()
                .describe("If user registered to the event")
                .optional(),
              complete: z
                .boolean()
                .describe("If event is full or not")
                .default(false),
              pre_access: z
                .boolean()
  ...
  .describe("Event listing all available events");
