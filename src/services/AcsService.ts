...
export class AcsService {
  private createSoapClientRequest(
    ...
    const strUrl = `${process.env.ACS_API_ENDPOINT ?? ""}${process.env.ACS_PROVISIONING_PATH ?? "/soap/?wsdl"}`
  ...
  async createUser(
    ...
    try {
      ...
      objRequest =
        objRequest || this.createSoapClientRequest("create", strMsisdn, strOtp, countrycode)
      ...
      parseString(xmlString, (err: any, result: any) => {
        ...
        errorCode =
          result["SOAP-ENV:Envelope"]["SOAP-ENV:Body"][0]["ns1:createSubscriberResponse"][0][
            "return"
          ][0]["errorCode"][0]._
        errorMessage =
          result["SOAP-ENV:Envelope"]["SOAP-ENV:Body"][0]["ns1:createSubscriberResponse"][0][
  ...
  async updateUser(
    ...
    try {
      ...
      objRequest =
        objRequest || this.createSoapClientRequest("update", strMsisdn, strOtp, countrycode)
      ...
      parseString(xmlString, (err: any, result: any) => {
        ...
        errorCode =
          result["SOAP-ENV:Envelope"]["SOAP-ENV:Body"][0]["ns1:updateSubscriberResponse"][0][
            "return"
          ][0]["errorCode"][0]._
        errorMessage =
          result["SOAP-ENV:Envelope"]["SOAP-ENV:Body"][0]["ns1:updateSubscriberResponse"][0][
