...
export class StreamUrlService {
  ...
  async getStreamUrls(streamUrlId: number, userId: number, ip: string, maxResults = 10): Promise<any>
  {
  ...
  async getMccMncRulesUrl(mcc = 0, mnc = 0, msisdn = "", city = "", countryCode = 0, regionCode = "")
  {
